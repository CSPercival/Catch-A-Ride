...
class allStopsStrategy:
    ...
    def find_meeting_point(self, car_start_coord: Coordinate, pt_start_coord: Coordinate, finish_coord: Coordinate, 
        ...
        pt_mp_reach_times = [pt_start_time, self.MPS.pt_client.get_reach_time(pt_start_coord, car_start_coord, pt_start_time)[0]] + [pt_stop_reach_time[0] for pt_stop_reach_time in pt_stop_reach_times]
